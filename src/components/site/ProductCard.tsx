  ...
  return (
    <div className="group flex flex-col">
      ...
      <div className="mt-4 flex-1 flex flex-col">
        <div className="text-[11px] tracking-[0.2em] uppercase text-muted-foreground">{product.categoryLabel}</div>
        ...
        <div className="mt-3 flex items-end justify-between">
          ...
          <Button size="sm" variant="outline" onClick={() => add(product.slug)}>Add</Button>
        </div>
      </div>
    </div>
  );
