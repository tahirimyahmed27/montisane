...
export const Route = createFileRoute("/article/$slug")({
  ...
  notFoundComponent: () => {
    const { t } = useI18n();
    return (
      <div className="min-h-screen flex flex-col items-center justify-center container-x py-20 text-center">
        <h1 className="font-serif text-4xl">{t("journal.notFound")}</h1>
        <Button asChild className="mt-4">
          <a href="/journal">Retour au journal</a>
        </Button>
      </div>
    );
  },
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="container-x py-16">
        <div className="bg-sage-deep text-ivory rounded-2xl p-12 text-center max-w-3xl mx-auto">
          <h2 className="font-serif text-3xl mb-4">Découvrez plus d'articles</h2>
          ...
          >
            <a href="/journal">Voir tous les articles</a>
          </Button>
        </div>
      </section>
    </div>
