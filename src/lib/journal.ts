...
Notre Detox Dawn combine gentiane et chardon-Marie dans une formule matinale conçue pour réveiller le métabolisme.`,
...
Our Detox Dawn combines gentian and milk thistle in a morning formula designed to wake up the metabolism.`,
    },
    relatedProducts: ["detox-dawn"],
  },
  {
    slug: "rituel-matin",
    title: {
...
- 7h00 : infusion Detox Dawn (gentiane, chardon-Marie, romarin)
...
- 7:00 AM: Brew Detox Dawn (gentian, milk thistle, rosemary)
...
A ritual is not built in a day. It is built by repeating the same loving gestures, until they become as natural as breathing.`,
    ...
    relatedProducts: ["detox-dawn", "golden-spark"],
  },
];
